...
const AvatarNav: React.FC<AvatarProps> = ({ image }) => {
  return (
    <>
      <div className="dropdown dropdown-end">
        ...
        <ul
          tabIndex={0}
          className={`dropdown-content menu bg-base-100 font-semibold text-gray-700 ${josefin.className} rounded-box mt-3.5 z-1 w-52 p-2 shadow-md`}
        >
          <div
